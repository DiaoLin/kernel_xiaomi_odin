...
setup_kernelsu() {
	...
	if [ ! -d "$GKI_ROOT/KernelSU" ]; then
		git clone https://gh-proxy.cn/https://github.com/ReSukiSU/ReSukiSU KernelSU
...
setup_submodule() {
    ...
    git submodule add https://gh-proxy.cn/https://github.com/ReSukiSU/ReSukiSU KernelSU || echo '[!] Failed to add KernelSU as a submodule.'
    echo '[+] Done.'
}
